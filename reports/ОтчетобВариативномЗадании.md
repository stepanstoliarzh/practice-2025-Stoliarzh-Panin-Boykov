...
<img src="/reports/images/amass_install.jpg" alt="Пенал с подарками" width="500"/>  

**Установка Amass**

- #### 2. Nmap - сканирование портов
<img src="/reports/images/nmap_install.jpg" alt="Пенал с подарками" width="500"/>  
*Установка Nmap*

- #### 3. Shodan - анализ сервисов и уязвимостей
<img src="/reports/images/Shodan_register.jpg" alt="Пенал с подарками" width="500"/>   
*Регистрация на Shodan*

- #### 4. LeakIX - поиск утечек данных
<img src="/reports/images/LeakIX_register.jpg" alt="Пенал с подарками" width="500"/>   
*Регистрация на LeakIX*

- #### 5. WHOIS - информация о домене
<img src="/reports/images/WHOIS_install.jpg" alt="Пенал с подарками" width="500"/>   
*Установка whois-утилиты*

- #### 6. Hunter.io - анализ технологического стека
<img src="/reports/images/hunterio_register.jpg" alt="Пенал с подарками" width="500"/>   
